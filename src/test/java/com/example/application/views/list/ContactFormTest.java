...
public class ContactFormTest {
    ...
    public void SaveEventHasCorrectValues(){
        ...
        form.firstName.setValue("Van");
        form.lastName.setValue("VanVan");
        form.email.setValue("Van@van.van");
        ...
        Assert.assertEquals("Van", saved.getFirstName());
        Assert.assertEquals("VanVan", saved.getLastName());
        Assert.assertEquals("Van@van.van", saved.getEmail());
